module.exports = {
    ...
    aliases: [],
    category: 'Music',
    utilisation: '{prefix}volume [1-250]',
    ...
    execute(client, message, args) {
        ...
        if (Math.round(parseInt(args[0])) < 1 || Math.round(parseInt(args[0])) > 250) return message.channel.send(`${client.emotes.error} - Please enter a valid number (between 1 and 100) !`);
